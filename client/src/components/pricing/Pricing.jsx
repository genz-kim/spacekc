...
const Pricing = () => {
  return (
		<div className="w-full py-10 flex flex-col gap-4 justify-center text-center bg-[#fafaff]">
			<div className='flex flex-col'>
				<h1 className="text-xl md:text-2xl text-secondary">Pricing</h1>
				<p className='text-secondary text-sm'>Explore for free and unlock for additional features</p>
			</div>
			<PricingSaving />
			<div className="flex flex-col md:flex-row gap-4 py-6 items-stretch">
				{pricingData.map((plan, idx) => (
					<PricingCard
						className={`w-full max-w-xs mx-auto md:w-full flex flex-col py-6`}
						key={idx}
					>
